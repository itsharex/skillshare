...
const ALL_STEPS: TourStep[] = [
  ...
  { id: 'skills-view', page: '/resources', targetSelector: "[data-tour='skills-view']", title: 'Resource Management', description: 'Browse all installed skills and agents. Switch between Skills and Agents tabs, with grid, folder, and table views.', emptyDescription: 'No resources yet. After the tour, try installing your first skill from Search or Install!', placement: 'bottom' },
